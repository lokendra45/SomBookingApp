...
import com.fourteen.sombookingapp.data.api.catchApiError
import com.fourteen.sombookingapp.data.api.safeApiCall
...
class BookingRepositoryImpl(
    ...
    }.catchApiError().flowOn(Dispatchers.IO)
    ...
    override suspend fun createBooking(request: BookingRequest): ApiResult<Booking> = safeApiCall {
